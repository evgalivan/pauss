    ...
    while True:
        ...
        if status == status_ready:  # если прибор готов, то запускаю измерения
            ...
            if error == error_loop_recall:
                ...
                # TODO доработь алгоритм, чтобы при режиме п - сразу шли замеры спектра сравнения
...
# Шаг 1. Отобразить преветствие в терминал.
print('Программа автоматизации управления для снятия спектров газов и газовых смесей (ПАУСС) версия 2.34')
